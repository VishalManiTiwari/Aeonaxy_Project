...
const LandingPage = () => {
  return (
    <div className="flex flex-col items-center justify-center min-h-screen ">
      ...
      <p className='text-[gray] text-[20px] relative top-[4px] xl:mr-[69rem] mr-[19rem] md:mr-[36.5rem]'><FaAngleLeft /></p>
      </Link>
      <div className="text-center mb-8">
        <h1 className="text-4xl font-bold py-4 text-green-600">Welcome to Brilliant</h1>
      </div>
      <div className='items-center justify-center gap-8 p-7  xl:flex md:flex xl:gap-[6rem]  md:gap-[3rem] p-7 '>
        <div className="w-64">
